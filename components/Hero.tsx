      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            background: "#17a7ce", display: "inline-block",
          }} />
        ...
        <p style={{
          fontSize: "1.05rem", color: "#6b7f89", lineHeight: 1.8,
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <Link href="#apply" style={{
            background: "#0a0f12", color: "#fff", padding: "14px 28px",
            borderRadius: 8, fontSize: "0.9rem", fontWeight: 600, textDecoration: "none",
          }}>
            Become a Distributor →
          </Link>
          <Link href="#products" style={{
            border: "1.5px solid #e4ecef", color: "#0a0f12", padding: "14px 28px",
        ...
        {images.map((src, i) => (
          <Image
            ...
            style={{
              ...
              opacity: current === i ? (fading && current === i ? 0 : 1) : (fading && (current + 1) % images.length === i ? 1 : 0),
